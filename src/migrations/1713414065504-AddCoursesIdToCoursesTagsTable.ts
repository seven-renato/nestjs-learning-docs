...
export class AddCoursesIdToCoursesTagsTable1713414065504 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.createForeignKey("courses_tags_tags", new TableForeignKey({
            ...
            columnNames: ['coursesId'], // Coluna da tabela courses_tags, que se relaciona com a tabela _courses
